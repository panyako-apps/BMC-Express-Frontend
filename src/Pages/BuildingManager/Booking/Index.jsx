...
function BuildingManagerBookingsIndex() {
    ...
    const handleDebouncedSearch = debounce(fetchBookings, 500)
                    ...
                    {bookings.map((booking, index) => 
                        ...
                        <tr key={booking.id} className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            ...
                            <td className="text-gray-900 font-light px-2 py-4">
                                <span>{booking.flat_name}</span>
                            </td>
                            <td className="text-gray-900 font-light px-2 py-4">
                                <span>{booking.first_name} {booking.other_names}</span>
                            </td>
                            <td className="text-gray-900 font-light px-2 py-4">
                            ...
                            <td className="text-gray-900 font-light px-2 py-4">
                            <span>{moment(booking.created_at).format('MMMM Do, YYYY')}</span>
                            </td>
                            <td className="text-gray-900 font-light px-2 py-4">
                                ...
                                <Dropdown>
                                    ...
                                    {/* <Dropdown.Content>
                                        <Dropdown.Link to={`/building_manager/booking/${booking.id}/edit`}>
...
export default BuildingManagerBookingsIndex
