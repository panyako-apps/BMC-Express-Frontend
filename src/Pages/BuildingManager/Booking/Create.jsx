...
export default function BuildingManagerBookingCreate() {
    ...
    //     try {
    //         await axios.post('http://localhost:8800/api/tenants', inputs);
    ...
    return (
        <BuildingManagerDashboardLayout>
            ...
            <div className="container mx-auto py-16">
                ...
                <div className="mb-8">
                    <Link to={`/building-manager/${currentBuildingManager.id}/bookings`} className="rounded-md bg-orange-600 hover:bg-orange-700 pl-3 pr-4 py-2 text-white"> <font-awesome-icon icon="fa-chevron-left"></font-awesome-icon> Back</Link>
                </div>
                <div className="bg-white rounded-lg overflow-hidden">
                    <div className="relative">
                        <div className="flex gap-2 items-center bg-slate-200 rounded-t px-4 py-2">
                            <div className="py-2">
                                <h4 className="font-bold text-color-main leading-4 text-lg uppercase">Book a Flat For a Resident</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center h-96">
                        <h1 className='text-orange-600 text-3xl text-center'>Booking Form Here</h1>
                    </div>
