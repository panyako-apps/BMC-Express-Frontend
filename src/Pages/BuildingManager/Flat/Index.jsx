...
import DeleteFlatButton from './Delete';
import debounce from 'lodash/debounce'


function BuildingManagerFlatsIndex() {
    ...
    const handleDebouncedSearch = debounce(fetchFlats, 500)
        ...
        <BuildingManagerDashboardLayout>
            <section className="container mx-auto px-8 pb-8">
                <div className="py-4 flex justify-between">
                    <span className="text-slate-500 uppercase text-xl"><span className="text-orange-600">Houses / Flats</span></span>
                    <Link to={'/building-manager/flat/create'} className={btnClasses}>Add Flat</Link>
                </div>
                ...
                <table className="min-w-full text-sm">
                    ...
                    {flats.map((flat, index) => 
                        (
                        <tr key={flat.id} className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            ...
                            <td className="text-gray-900 font-light px-2 py-4">
                                ...
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        <Dropdown.Link to={`/building-manager/flat/${flat.id}/edit`}>
                                        ...
                                        <Dropdown.Link >
                                            <DeleteFlatButton 
                                                flat={flat}
                                                onFlatDeleted={handleDeletedFlat}
                                                />
                                        </Dropdown.Link>
...
export default BuildingManagerFlatsIndex
