...
import companyAuthImage from '../../../assets/images/settings/company-auth.jpg';

export default function LoginCompany({status, canResetPassword}) {
    ...
    return (
        <div className='h-screen'>
            <div  className="flex justify-center h-full relative">
                <div className="flex flex-col justify-between z-30">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="md:flex items-center gap-2">
                            <Link to={'/building-manager/login'} className="py-1.5 px-6 w-full text-center rounded-lg text-white bg-orange-600 hover:bg-orange-500 border border-orange-600 transition-all duration-300 ease-in-out"> Manager</Link>
                ...
                <img src={companyAuthImage} alt="" className="absolute inset-0 w-full h-full object-cover " />
