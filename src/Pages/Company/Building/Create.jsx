...
export default function CompanyBuildingCreate() {
    ...
    const submit = async (e) => {
        ...
        try {
            await axios.post('http://localhost:8800/api/buildings/store', inputs);
                ...
                <div className="bg-white rounded-lg overflow-hidden">
                    <div className="relative">
                        <div className="flex gap-2 items-center bg-slate-200 rounded-t px-4 py-2">
                            <div className="py-2">
                                <h4 className="font-bold text-color-main leading-4 text-lg uppercase">Add a Building</h4>
                            </div>
                        </div>
                    </div>
                    {isProcessing ? 
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <InputLabel htmlFor="project_id" value={'Projects'}/>
                            <select 
                                ...
                                )) : <option>Fetching projects ...</option>}
