...
import DeleteBuildingButton from './Delete';
import debounce from 'lodash/debounce'


function CompanyBuildingsIndex() {
        ...
        <CompanyDashboardLayout>
            <section className="container mx-auto px-8 pb-8">
                <div className="py-4 flex justify-between">
                    <span className="text-slate-500 uppercase text-xl">{currentCompany.name} - <span className="text-orange-600">buildings</span></span>
                    <Link to={'/company/building/create'} className={btnClasses}>Create building</Link>
                </div>
                        ...
                        <tr key={building.id} className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            ...
                            <td className="text-gray-900 font-light px-2 py-4">
                                ...
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        <Dropdown.Link to={`/company/building/${building.id}/edit`}>
                                        ...
                                        <Dropdown.Link >
                                            <DeleteBuildingButton 
                                                building={building}
                                                onBuildingDeleted={handleDeletedBuilding}
                                                />
                                        </Dropdown.Link>
...
export default CompanyBuildingsIndex
