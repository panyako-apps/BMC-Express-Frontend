...
const DeleteBuildingManagerButton = ({ buildingManager, onBuildingManagerDeleted }) => {
  ...
  const deleteBuidlingManager = async () => {
   
    setInProgress(true);

    try {
        await axios.delete(`/building-managers/${buildingManager.id}`);
        onBuildingManagerDeleted();
        ...
        {inProgress ? (
          ...
          <div className="p-6">
            <div className="flex gap-2 items-center mb-3">
              <h2 className="text-red-500">Are you sure, you want to delete this Manager Account?</h2>
            </div>

            <div className="flex gap-2">
              <button
                type="button"
                onClick={deleteBuidlingManager}
...
export default DeleteBuildingManagerButton;
