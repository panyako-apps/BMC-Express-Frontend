...
const DeleteCommonFacilityButton = ({ commonFacility, onCommonFacilityDeleted }) => {
  ...
  const deleteCommonFacility = async () => {
   
    setInProgress(true);

    try {
        await axios.delete(`/common-facilities/${commonFacility.id}`);
        onCommonFacilityDeleted();
        ...
        {inProgress ? (
          ...
          <div className="p-6">
            <div className="flex gap-2 items-center mb-3">
              <h2 className="text-red-500">Are you sure, you want to delete this Facility?</h2>
            </div>

            <div className="flex gap-2">
              <button
                type="button"
                onClick={deleteCommonFacility}
...
export default DeleteCommonFacilityButton;
