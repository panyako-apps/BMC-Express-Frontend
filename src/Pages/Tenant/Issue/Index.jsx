...
function TenantIssuesIndex() {
    ...
    const fetchIssues = async () => {
        try {
            const res = await axios.get('http://localhost:8800/api/issues', {
                params: {
        ...
        <TenantDashboardLayout>
            <section className="container mx-auto px-8 pb-8">
                <div className="py-4 flex justify-between">
                    <span className="text-slate-500 uppercase text-xl"><span className="text-orange-600">issues</span></span>
                    <Link to={'/tenant/issue/create'} className={btnClasses}>Report an Issue</Link>
                </div>
                ...
                <table className="min-w-full text-sm">
                    ...
                    {issues.map((issue, index) => 
                        (
                        <tr key={issue.id} className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            ...
                            <td className="text-gray-900 font-light px-2 py-4">
                                ...
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        <Dropdown.Link to={`/tenant/issue/${issue.id}/edit`}>
