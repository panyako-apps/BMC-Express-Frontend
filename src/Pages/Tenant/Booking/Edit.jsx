...
export default function TenantIssueEdit() {
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            navigate(`/company/${currentTenant.id}/issues`)
        } catch (error) {
            console.log(error)
    ...
    return (
        <TenantDashboardLayout>
            <div className="container mx-auto py-16">
                ...
                <div className="mb-8">
                    <Link to={`/company/${currentTenant.id}/issues`} className="rounded-md bg-orange-600 hover:bg-orange-700 pl-3 pr-4 py-2 text-white"> <font-awesome-icon icon="fa-chevron-left"></font-awesome-icon> Back</Link>
                </div>
                   ...
                   ( <form onSubmit={submit} className='p-6'>
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className=''>
                            ...
                            <InputLabel htmlFor="name" value={'Issue Name'}/>
                            <TextInput
                                id="name"
                                type="text"
                                name="name"
