        ...
        <TenantDashboardLayout>
            <section className="container mx-auto px-8 pb-8">
                <div className="py-4 flex justify-between">
                    ...
                    <Link to={'/tenant/bill/create'} className={btnClasses}>View Bill</Link>
                </div>
                ...
                <table className="min-w-full text-sm">
                    ...
                    {bills.map((bill, index) => 
                        ...
                        <tr key={bill.id} className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            ...
                            <td className="text-gray-900 font-light px-2 py-4">
                                <span>{moment(bill.duedate).format('MMMM Do, YYYY')}</span>
                            </td>
                            <td className="text-gray-900 font-light px-2 py-4">
                                <span>{moment(bill.time).format('h:mm:ss a')}</span>
                            </td>
                            <td className="text-gray-900 font-light px-2 py-4">
                                ...
                                <Dropdown>
                                    ...
                                    {/* <Dropdown.Content>
                                        ...
                                        <Dropdown.Link to={`/tenant/bill/${bill.id}/edit`}>
                                            <span className="px-6">
...
export default TenantBillsIndex
