...
const DeleteBuildingButton = ({ building, onBuildingDeleted }) => {
  ...
  const deleteBuilding = async () => {
    ...
    try {
        await axios.delete(`/buildings/${building.id}`);
        onBuildingDeleted();
        ...
        {inProgress ? (
          ...
          <div className="p-6">
            <div className="flex gap-2 items-center mb-3">
              <h2 className="text-red-500">Are you sure, you want to delete this Building?</h2>
            </div>
